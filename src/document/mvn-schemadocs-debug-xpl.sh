...
CALABASH_ARGS="-iMETASCHEMA=\"$METASCHEMA_XML\" \
               ...
               -oJSON-object-map-div=/dev/null \
               -oJSON-object-reference-div=/dev/null \
               -oJSON-object-index-div=/dev/null \
               -oJSON-definitions-div=/dev/null \
               -oXML-element-map-div=/dev/null \
               -oXML-element-reference-div=/dev/null \
               -oXML-element-index-div=/dev/null \
               -oXML-definitions-div=/dev/null \
